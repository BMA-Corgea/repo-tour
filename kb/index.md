...
| Why repo-tour is Node + TypeScript (and not Python) | [wiki/decision-implementation-language.md](wiki/decision-implementation-language.md) | Locked 2026-08-26 by Evan; binds T-1 and everything downstream |
